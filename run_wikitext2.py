...
def train_and_eval():
    ...
    # print(f"torch.cuda.memory_allocated: {torch.cuda.memory_allocated() / 1024 / 1024:.2f} MiB, torch.cuda.max_memory_allocated: {torch.cuda.max_memory_allocated() / 1024 / 1024:.2f} MiB, torch.cuda.memory_reserved: {torch.cuda.memory_reserved() / 1024 / 1024:.2f} MiB, torch.cuda.max_memory_reserved: {torch.cuda.max_memory_reserved() / 1024 / 1024:.2f} MiB")
